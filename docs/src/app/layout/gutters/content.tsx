    ...
    return(
        <div className="withPrimaryBackground listViewVertical paddingSmall textLight">
                        ...
                        <span className="highlighted">
                            invrz patterns comes out of the box with max gutter sizes till 60, which can be changed as per requirements by editing the <span className="inlineCode bgAccent textLight">$gutters</span> value in <span className="inlineCode bgAccent textLight">variables.scss</span> file according to your needs. For this documentation we will stick to the default 60 gutter sizes but the general rules will be same for any number of <span className="inlineCode bgAccent textLight">$gutters</span> you set.
                        </span><br/><br/>

                        Gutters are essential for creating separations between grid columns, providing spacing and visual clarity in layouts. <br/>
                        You can use classes <span className="inlineCode bgAccent textLight">.gutterWd-*</span> to add gutters of size <span className="inlineCode bgAccent textLight">*</span> where  <span className="inlineCode bgAccent textLight">*</span>  ranges from 1 to 60 by default. The larger the number, the bigger will be space between your columns. For example:
                            <br/>
