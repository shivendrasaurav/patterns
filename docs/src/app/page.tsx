  ...
  return(
    <div className="pageView">
        ...
        <div className="gridRow rowCenter rowMiddle">
            <div className="colWd-12-ld colWd-12-sm colHi-6">
              <h1>Invrz Patterns - Alpha</h1><br/>
              <p>Invrz Patterns is a new age UI Library to help developers build webpages faster. It minimizes use of CSS by including a lot of utlility classes such as <span className="inlineCode">.taCenter</span> which can be used to align any text to center of parent element without worrying about underlying CSS.</p><br/>
              ...
              <p className="codeBlock paddingSmall">npm install patterns-ui</p><br/>
              <p>After installation you can head over to docs and start making awesome grids.</p>
              <p><a href="/layout/views"><button className="paddingSmall withPrimaryBackground noBorders smoothEdge">Docs - Alpha</button></a></p><br/><br/>
            </div>
        </div><br/><br/>
    </div>
  );
