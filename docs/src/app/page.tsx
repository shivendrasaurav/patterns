...
const Home = () =>{
  ...
  return(
    <div className="pageView textLight bgDark">
        ...
        <div className="gridRow rowCenter rowMiddle">
            <div className="colWd-12-ld colWd-12-sm colHi-6">
              ...
              <p className="codeBlock paddingSmall bgBrand textLight">npm install patterns-ui</p><br/>
              <p>After installation you can head over to docs and start making awesome grids.</p><br/>
              <p><a href="/layout/views"><button className="paddingSmall bgAccent textLight noBorders smoothEdge">Docs - Alpha</button></a></p><br/><br/>
            </div>
        </div><br/><br/>
    </div>
  );
